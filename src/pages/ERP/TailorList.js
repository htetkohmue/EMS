...
import { TailorListHead, TailorListToolbar, TailorMoreMenu ,Loading} from '../../sections/ERP/TailorList';
    ...
    <Page title="TailorList">
      ...
      {loadingOpen && (<Loading loadingOpen={loadingOpen} />)}
        <Stack direction="row" alignItems="center" justifyContent="space-between" mb={5}>
          ...
          <Button variant="contained" component={RouterLink} to="/erp/tailor/tailors-register" startIcon={<Iconify icon="eva:plus-fill" />}>
            {t('New Tailor')}
          </Button>
        </Stack>
        {successMsg && (
